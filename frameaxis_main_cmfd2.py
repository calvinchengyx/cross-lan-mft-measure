...
if __name__ == '__main__':
    ...
    if args.word_embedding_model is not None:
        ...
        print('Downloading multilingual word embedding model: XLM-R')
    ...
    # fa = FrameAxis(mfd=DICT_TYPE, model_name='xlm-roberta-base')
    fa = FrameAxis(mfd=DICT_TYPE, model_name='')

    mf_scores = fa.get_fa_scores(df=data, 
                                 doc_colname=DOCS_COL, 
                                 tfidf=False, 
                                 format="virtue_vice",
